...
@Stateless(name = "GfaceGuatefacturaValidationsEjbLocalImpl", mappedName = "ejb/GfaceGuatefacturaValidationsEjbLocalImpl")
@Remote(GfaceGuatefacturaValidationsEjbLocal.class)
