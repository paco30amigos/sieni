...
@NamedQueries({
    ...
    @NamedQuery(name = "SieniClase.findClaseByTipoAlumno", query = "SELECT s FROM SieniClase s,SieniAlumno al join fetch al.sieniMatriculaList m where m.idGrado.idGrado=s.idCurso.idGrado.idGrado and m.idAlumno.idAlumno=al.idAlumno and s.clEstado not in (:estado) and s.clTipo=:tipoClase and al.idAlumno=:idAlumno"),
