...
@NamedQueries({
    ...
    @NamedQuery(name = "SieniClase.findClaseByTipoAlumno", query = "SELECT c FROM SieniClase c,SieniCursoAlumno ca join ca.idCurso.sieniClaseList cl where cl.idClase=c.idClase and ca.idAlumno=:idAlumno and cl.clEstado not in (:estado) and ca.idCurso.crEstado not in (:estado) and c.clTipo=:tipoClase order by c.idClase"),
