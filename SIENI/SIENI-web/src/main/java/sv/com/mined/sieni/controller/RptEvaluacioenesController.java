...
//        parameterMap.put("seccion", this.getSeccion() != null ? this.getSeccion() : "Todos");
        ...
        try {
            ...
            sieniBitacoraFacadeRemote.create(new SieniBitacora(new Date(), "Generar Reporte", "Evalaucion", loginBean.getIdUsuario(), loginBean.getTipoUsuario().charAt(0), req.getRemoteAddr()));
