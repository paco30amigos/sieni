...
public class CursoConverter implements Converter {
    ...
    public Object getAsObject(FacesContext arg0, UIComponent arg1, String arg2) {
        ...
        if (arg1 instanceof SelectOneMenu) {
            ...
            for (UIComponent item : (List<UIComponent>) menuItems) {
                ...
                for (SieniCurso actual : (List<SieniCurso>) select.getValue()) {
                    if (arg2.equals(actual.getIdCurso().toString())) {
                        ret = actual;
                    }
                }
            }
    ...
    public String getAsString(FacesContext arg0, UIComponent arg1, Object arg2) {
        String str = "";
        if (arg2 instanceof SieniCurso) {
            str = "" + ((SieniCurso) arg2).getIdCurso();
        }
        return str;
    }
}
