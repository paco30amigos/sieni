 ...
 * @author Laptop
 */
@FacesConverter(value = "evaluacion")
public class EvaluacionConverter implements Converter {
    ...
    public Object getAsObject(FacesContext arg0, UIComponent arg1, String arg2) {
        ...
        if (arg1 instanceof SelectOneMenu) {
            ...
            for (UIComponent item : (List<UIComponent>) menuItems) {
                ...
                for (SieniEvaluacion actual : (List<SieniEvaluacion>) select.getValue()) {
                    if (arg2.equals(actual.getIdEvaluacion().toString())) {
                        ret = actual;
                    }
                }
            }
    ...
    public String getAsString(FacesContext arg0, UIComponent arg1, Object arg2) {
        String str = "";
        if (arg2 instanceof SieniEvaluacion) {
            str = "" + ((SieniEvaluacion) arg2).getIdEvaluacion();
        }
        return str;
    }
}
