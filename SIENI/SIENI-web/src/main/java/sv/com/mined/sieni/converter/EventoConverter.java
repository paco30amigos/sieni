...
public class EventoConverter implements Converter {
    ...
    public Object getAsObject(FacesContext arg0, UIComponent arg1, String arg2) {
        ...
        if (arg1 instanceof SelectOneMenu) {
            ...
            for (UIComponent item : (List<UIComponent>) menuItems) {
                ...
                for (SieniEvento actual : (List<SieniEvento>) select.getValue()) {
                    if (arg2.equals(actual.getIdEvento().toString())) {
                        ret = actual;
                    }
                }
            }
    ...
    public String getAsString(FacesContext arg0, UIComponent arg1, Object arg2) {
        String str = "";
        if (arg2 instanceof SieniEvento) {
            str = "" + ((SieniEvento) arg2).getIdEvento();
        }
        return str;
    }
}
