 ...
 * @author Laptop
 */
@FacesConverter(value = "plantilla")
public class PlantillaConverter implements Converter {
    ...
    public Object getAsObject(FacesContext arg0, UIComponent arg1, String arg2) {
        ...
        if (arg1 instanceof SelectOneMenu) {
            ...
            for (UIComponent item : (List<UIComponent>) menuItems) {
                ...
                for (SieniPlantilla actual : (List<SieniPlantilla>) select.getValue()) {
                    if (arg2.equals(actual.getIdPlantilla().toString())) {
                        ret = actual;
                    }
                }
            }
    ...
    public String getAsString(FacesContext arg0, UIComponent arg1, Object arg2) {
        String str = "";
        if (arg2 instanceof SieniPlantilla) {
            str = "" + ((SieniPlantilla) arg2).getIdPlantilla();
        }
        return str;
    }
}
