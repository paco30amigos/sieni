...
public class SeccionConverter implements Converter {
    ...
    public Object getAsObject(FacesContext arg0, UIComponent arg1, String arg2) {
        ...
        if (arg1 instanceof SelectOneMenu) {
            ...
            for (UIComponent item : (List<UIComponent>) menuItems) {
                ...
                for (SieniSeccion actual : (List<SieniSeccion>) select.getValue()) {
                    if (arg2.equals(actual.getIdSeccion().toString())) {
                        ret = actual;
                    }
                }
            }
    ...
    public String getAsString(FacesContext arg0, UIComponent arg1, Object arg2) {
        String str = "";
        if (arg2 instanceof SieniSeccion) {
            str = "" + ((SieniSeccion) arg2).getIdSeccion();
        }
        return str;
    }
}
